...
URL: `https://dermatologo.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `dermatologo.demo.federicocalo.dev`
...
- Output directory: `dist/dermatologo/browser`
...
URL: `https://fedcal.github.io/federico-demo-dermatologo/`
...
- `base: /federico-demo-dermatologo/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `dermatologo-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   dermatologo-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `dermatologo-docs.federicocalo.dev`
