...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/demo-dermatologo
...
```bash
git clone https://github.com/fedcal/demo-dermatologo.git
cd demo-dermatologo
npm install
npm start
# → http://localhost:4200
...
- [GitHub repo](https://github.com/fedcal/demo-dermatologo)
