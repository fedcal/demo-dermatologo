...
hero:
  name: "Demo Dermatologo"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://dermatologo.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-dermatologo
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Dermatologo.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Dermatologo** in Italia.
...
Il mercato italiano delle PMI per **Dermatologo** ha caratteristiche specifiche:
...
```bash
git clone https://github.com/fedcal/federico-demo-dermatologo.git
cd federico-demo-dermatologo
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-dermatologo)
