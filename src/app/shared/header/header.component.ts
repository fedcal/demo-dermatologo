  ...
  template: `
    <header class="site-header">
      <div class="site-header__inner">
        <a routerLink="/" class="brand" aria-label="Home — Studio Dermatologico Russo">
          <span class="brand__icon" aria-hidden="true">🧴</span>
          <span class="brand__text">Studio Russo</span>
        </a>
        <nav class="site-nav" aria-label="Navigazione principale">
          ...
          <a routerLink="/contatti" routerLinkActive="is-active" class="cta">Prenota visita</a>
        </nav>
      </div>
    </header>
  `,
